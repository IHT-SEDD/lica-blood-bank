...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('crossmatch_histories', function (Blueprint $table) {
            $table->unsignedBigInteger('blood_transfusion_detail_id')
                ->nullable()
                ->after('id');

            $table->foreign('blood_transfusion_detail_id')
                ->references('id')
                ->on('blood_transfusion_details')
                ->onDelete('set null');
    ...
    public function down(): void
    {
        Schema::table('crossmatch_histories', function (Blueprint $table) {
            ...
            $table->foreign('blood_transfusion_id')
                ->references('id')
                ->on('blood_transfusions')
                ->onDelete('set null');
        });
    }
};
