...
document.addEventListener("DOMContentLoaded", () => {
    const exportDataTable = document.querySelector(
        '[data-tables="export-data"]',
    );
    if (exportDataTable) {
        new DataTable(exportDataTable, {
            dom:
                "<'d-md-flex justify-content-between align-items-center my-2'Bf>" +
                "rt" +
            ...
            initComplete: function () {
                setTimeout(() => {
                    document
                        .querySelectorAll(".dt-buttons .btn-secondary")
                        .forEach((btn) => {
    ...
    const exportDropdownTable = document.querySelector(
            ...
            buttons: [
                {
                    ...
                    className:
                        "btn btn-sm btn-primary dropdown-toggle drop-arrow-none",
                    autoClose: true,
                    buttons: [
                        {
                            extend: "copy",
