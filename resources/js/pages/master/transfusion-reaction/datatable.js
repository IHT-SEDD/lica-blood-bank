...
// Filter datatable
const DateFilterSelector = ".master-transfusion-reaction-table-date-filter"; // class selector filter tanggal

// Datatable
const DatatableSelector = "#master-transfusion-reaction-table"; // id selector datatable
const MasterDataURL = "/master/transfusion-reaction/data"; // url fetch data untuk datatable
const ReloadDatatableSelector = "master-transfusion-reaction-reload"; // index reload datatable

// Edit Action
const FormEditSelector = "#edit_data_transfusion-reaction"; // id selector form edit
const ModalEditSelector = "edit_data_master_transfusion-reaction_modal"; // id selector modal edit
const ActionEditSelector = ".btn-edit-transfusion-reaction"; // class selector button edit
const AttributeEdit = "editId"; // attribute data id edit

// Delete Action
const ModalDeleteSelector = "delete_data_master_transfusion-reaction_modal"; // id selector modal delete
const ActionDeleteSelector = ".btn-delete-transfusion-reaction"; // class selector button delete
...
// Restore Action
const ModalRestoreSelector = "restore_data_master_transfusion-reaction_modal"; // id selector modal restore
const ActionRestoreSelector = ".btn-restore-transfusion-reaction"; // class selector button restore
...
function reloadTable() {
    if (masterTransfusionReactionTableInstance?.instance) {
        masterTransfusionReactionTableInstance.instance.ajax.reload();
    }
}
// ---------- Helper: Reload tabel :end ----------

// ---------- Datatable untuk master transfusion reaction :begin ----------
function MasterTransfusionReactionTable() {
    // ---------- Init kolom pada tabel ----------
    const MasterTransfusionReactionTableColumns = [
        {
            data: null,
            title: "No",
            ...
            render: (data, type, row, meta) => {
                ...
                data-bs-auto-close="true" type="button">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <button id="edit-data-${row.public_id}" class="dropdown-item btn-edit-transfusion-reaction" data-edit-id="${row.public_id}" type="button">
                            Edit</button>
                        </li>
                        <li>
                            <button id="restore-data-${row.public_id}" class="dropdown-item fw-medium btn-restore-transfusion-reaction ${isDeleted ? "enabled text-info" : "disabled"}" data-restore-id="${row.public_id}" type="button">
                            Restore</button>
                        </li>
                        <li>
                            <button id="delete-data-${row.public_id}" class="dropdown-item btn-delete-transfusion-reaction text-danger" data-delete-id="${row.public_id}" type="button">
                            Delete</button>
                        </li>
                    </ul>
                `;
    ...
    masterTransfusionReactionTableInstance = new GlobalAdvanceDatatable(
        "#master-transfusion-reaction-table",
        {
            ajax: {
                url: MasterDataURL,
                data: function (d) {
            ...
            columns: MasterTransfusionReactionTableColumns,
            useHideColumn: true,
            columnDefs: [
                {
                    targets: -1,
...
// ---------- Datatable untuk master transfusion reaction :end ----------
...
function EditDataTransfusionReactionActionModal() {
    new GlobalEditData({
...
function DeleteDataTransfusionReactionActionModal() {
...
function RestoreDataTransfusionReactionActionModal() {
    // Panggil dan setup delete data
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Action data
    EditDataTransfusionReactionActionModal();
    DeleteDataTransfusionReactionActionModal();
    RestoreDataTransfusionReactionActionModal();
