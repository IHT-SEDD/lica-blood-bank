...
// Filter datatable
const DateFilterSelector = ".master-test-table-date-filter"; // class selector filter tanggal

// Datatable
const DatatableSelector = "#master-test-table"; // id selector datatable
const MasterDataURL = "/master/test/data"; // url fetch data untuk datatable
const ReloadDatatableSelector = "master-test-reload"; // index reload datatable

// Edit Action
const FormEditSelector = "#edit_data_test"; // id selector form edit
const ModalEditSelector = "edit_data_master_test_modal"; // id selector modal edit
const ActionEditSelector = ".btn-edit-test"; // class selector button edit
const AttributeEdit = "editId"; // attribute data id edit

// Delete Action
const ModalDeleteSelector = "delete_data_master_test_modal"; // id selector modal delete
const ActionDeleteSelector = ".btn-delete-test"; // class selector button delete
...
// Restore Action
const ModalRestoreSelector = "restore_data_master_test_modal"; // id selector modal restore
const ActionRestoreSelector = ".btn-restore-test"; // class selector button restore
...
function reloadTable() {
    if (masterTestTableInstance?.instance) {
        masterTestTableInstance.instance.ajax.reload();
    }
}
// ---------- Helper: Reload tabel :end ----------

// ---------- Datatable untuk master test :begin ----------
function MasterTestTable() {
    // ---------- Init kolom pada tabel ----------
    const MasterTestTableColumns = [
        {
            data: null,
            title: "No",
            ...
            render: (data, type, row, meta) => {
                ...
                data-bs-auto-close="true" type="button">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <button id="edit-data-${row.public_id}" class="dropdown-item btn-edit-test" data-edit-id="${row.public_id}" type="button">
                            Edit</button>
                        </li>
                        <li>
                            <button id="restore-data-${row.public_id}" class="dropdown-item fw-medium btn-restore-test ${isDeleted ? "enabled text-info" : "disabled"}" data-restore-id="${row.public_id}" type="button">
                            Restore</button>
                        </li>
                        <li>
                            <button id="delete-data-${row.public_id}" class="dropdown-item btn-delete-test text-danger" data-delete-id="${row.public_id}" type="button">
                            Delete</button>
                        </li>
                    </ul>
                `;
...
// ---------- Datatable untuk master test :end ----------
...
function EditDataTestActionModal() {
    new GlobalEditData({
...
function DeleteDataTestActionModal() {
...
function RestoreDataTestActionModal() {
    // Panggil dan setup delete data
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Action data
    EditDataTestActionModal();
    DeleteDataTestActionModal();
    RestoreDataTestActionModal();
