...
// Filter datatable
const DateFilterSelector = ".master-insurance-table-date-filter"; // class selector filter tanggal

// Datatable
const DatatableSelector = "#master-insurance-table"; // id selector datatable
const MasterDataURL = "/master/insurance/data"; // url fetch data untuk datatable
const ReloadDatatableSelector = "master-insurance-reload"; // index reload datatable

// Edit Action
const FormEditSelector = "#edit_data_insurance"; // id selector form edit
const ModalEditSelector = "edit_data_master_insurance_modal"; // id selector modal edit
const ActionEditSelector = ".btn-edit-insurance"; // class selector button edit
const AttributeEdit = "editId"; // attribute data id edit

// Delete Action
const ModalDeleteSelector = "delete_data_master_insurance_modal"; // id selector modal delete
const ActionDeleteSelector = ".btn-delete-insurance"; // class selector button delete
...
// Restore Action
const ModalRestoreSelector = "restore_data_master_insurance_modal"; // id selector modal restore
const ActionRestoreSelector = ".btn-restore-insurance"; // class selector button restore
...
function MasterInsuranceTable() {
            ...
            render: (data, type, row, meta) => {
                ...
                data-bs-auto-close="true" type="button">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <button id="edit-data-${row.public_id}" class="dropdown-item btn-edit-insurance" data-edit-id="${row.public_id}" type="button">
                            Edit</button>
                        </li>
                        <li>
                            <button id="restore-data-${row.public_id}" class="dropdown-item fw-medium btn-restore-insurance ${isDeleted ? "enabled text-info" : "disabled"}" data-restore-id="${row.public_id}" type="button">
                            Restore</button>
                        </li>
                        <li>
                            <button id="delete-data-${row.public_id}" class="dropdown-item btn-delete-insurance text-danger" data-delete-id="${row.public_id}" type="button">
                            Delete</button>
                        </li>
                    </ul>
                `;
    ...
    masterInsuranceTableInstance = new GlobalAdvanceYajraDatatable(
...
function EditDataInsuranceActionModal() {
    new GlobalEditData({
...
function DeleteDataInsuranceActionModal() {
...
function RestoreDataInsuranceActionModal() {
    // Panggil dan setup delete data
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Action data
    EditDataInsuranceActionModal();
    DeleteDataInsuranceActionModal();
