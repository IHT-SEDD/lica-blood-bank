    ...
    <div class="col-lg-12">
      <div>
        <div class="form-check form-check-secondary my-1">
          <input checked="" class="form-check-input" id="edit_data_user_is_pj" name="is_pj" type="checkbox" />
          <label class="form-check-label" for="edit_data_user_is_pj">Penanggung Jawab?</label>
        </div>
      </div>
    </div>
