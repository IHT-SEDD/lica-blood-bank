...
<table class="table table-striped dt-responsive align-middle mb-0 master-transfusion-reaction-table" id="master-transfusion-reaction-table">
...
<form class="row g-2" id="add_new_transfusion-reaction" autocomplete="off">
  ...
  <div class="col-lg-12">
    ...
    <input autocomplete="off" class="form-control" id="name" name="name" type="text" placeholder="Enter Transfusion Reaction" />
  </div>
  {{-- Is Active? --}}
  <div class="col-lg-3">
    <div>
