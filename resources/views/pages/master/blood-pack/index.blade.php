...
<form class="row g-2" id="add_new_blood_pack" autocomplete="off">
  ...
  <div class="col-lg-6">
    <label class="form-label" for="storage_temperature_from">{{ __('Storage Temperature') }} {{ __('From') }}
      <span class="text-danger">*</span>
    </label>
    <input autocomplete="off" class="form-control" id="storage_temperature_from" name="storage_temperature_from" type="number" />
  </div>

  {{-- Storage Temperature To --}}
  <div class="col-lg-6">
    <label class="form-label" for="storage_temperature_to">{{ __('Storage Temperature') }} {{ __('To') }}
      <span class="text-danger">*</span>
    </label>
    <input autocomplete="off" class="form-control" id="storage_temperature_to" name="storage_temperature_to" type="number" />
  </div>
