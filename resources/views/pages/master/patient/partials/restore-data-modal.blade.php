<x-static-modal-layout id="restore_data_master_patient_modal" size="" title="Restore Data Patient">
 <h4 class="fw-semibold">Are your sure want to restore this patient?</h4>
