...
<div class="row py-3">
   ...
   <div class="card-body">
    <div class="row">
     ...
     <div class="col-xxl-4 col-12">
      ...
      {{-- Patient Room --}}
      <div class="row mb-2">
       <div class="col-12 text-capitalize text-muted fw-medium my-0" style="font-size: 11.5px;">{{ __('Ruangan / Jenis
        Pasien') }}</div>
       <div class="col-12 text-capitalize fs-6 fw-semibold my-0">
      ...
      {{-- Patient Diagnosis --}}
      <div class="row mb-2">
       <div class="col-12 text-capitalize text-muted fw-medium my-0" style="font-size: 11.5px;">{{ __('Diagnosis') }}
       </div>
     ...
     <div class="col-xxl-4 col-12">
      {{-- Created At --}}
      <div class="row mb-2">
       <div class="col-12 text-capitalize text-muted fw-medium my-0" style="font-size: 11.5px;">{{ __('Tgl. Dibuat') }}
       </div>
       <div class="col-12 text-capitalize fs-6 fw-semibold my-0" id="patient_detail" data-patient-detail="created_at">
       </div>
      </div>

      {{-- Dicheckin Oleh --}}
      <div class="row mb-2">
       <div class="col-12 text-capitalize text-muted fw-medium my-0" style="font-size: 11.5px;">{{ __('Checkin Oleh') }}
       </div>
       <div class="col-12 text-capitalize fs-6 fw-semibold my-0" id="patient_detail" data-patient-detail="checkedin_by">
       </div>
      </div>
      ...
      <div class="row mb-2">
       ...
       <div class="col-12 text-capitalize fs-6 fw-semibold my-0" id="patient_detail" data-patient-detail="lab_number">
       </div>
      </div>

      {{-- No. Order --}}
      <div class="row mb-2">
       <div class="col-12 text-capitalize text-muted fw-medium my-0" style="font-size: 11.5px;">{{ __('No. Order') }}
       </div>
       <div class="col-12 text-capitalize fs-6 fw-semibold my-0" id="patient_detail" data-patient-detail="order_number">
       </div>
      </div>
     </div>
    </div>
 ...
 <div class="col-12">
  ...
  <div class="card text-bg-dark border-0">
   ...
   {{-- Card Body --}}
   <div class="card-body">
    <table class="table table-sm table-centered table-hover table-sm dt-responsive align-middle mb-0 list-tests-table"
     id="list-tests-table">
