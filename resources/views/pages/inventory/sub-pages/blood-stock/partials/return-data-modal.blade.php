<x-static-modal-layout id="return_data_stock_blood_modal" size="" title="Konfirmasi Kembalikan Darah Ke Stock">
  {{-- Form Return :begin --}}
  <form class="row g-2" id="return_data_stock_blood" autocomplete="off" novalidate>
    <div class="row">
      {{-- Return reason --}}
      <div class="col-lg-12 mb-2">
        <label class="form-label" for="reason_return">{{ __('Alasan Pengembalian ke Stock') }}
          <span class="text-danger">*</span>
        </label>
        <textarea autocomplete="off" class="form-control" id="reason_return" name="reason_return" rows="5"
          placeholder="Tulis alasan pengembalian..."></textarea>
        <small class="form-text text-muted">
          {{ __('Alasan wajib diisi!') }}.
        </small>
      </div>
