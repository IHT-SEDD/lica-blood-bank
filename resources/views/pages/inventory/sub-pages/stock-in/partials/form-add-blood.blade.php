...
<form class="row g-2" id="add_new_blood" autocomplete="off">
 {{-- Patient Data :begin --}}
 <div class="col-lg-7 col-12 patient-data-border pe-lg-4">
  ...
  <div class="row g-2 my-2">
   ...
   <div class="col-lg-6 col-12">
    ...
    <select class="form-control" id="select-blood-type" name="blood_type" placeholder="Choose blood type..."></select>
   </div>
