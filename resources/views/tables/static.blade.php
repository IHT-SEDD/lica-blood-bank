...
@section('content')
    @include('layouts.shared/page-title', [
        'title' => 'Static Tables',
        'subTitle' => 'Display structured data using simple, responsive Bootstrap tables without dynamic interactivity or JS
        dependencies.',
        'badgeIcon' => 'table',
        'badgeTitle' => 'Bootstrap Tables',
    ])
    ...
    <div class="row justify-content-center">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header justify-content-between">
                    <h5 class="card-title"> Variants of Table </h5>
            ...
            <div class="card">
                <div class="card-header justify-content-between">
                    <h5 class="card-title"> Striped Columns </h5>
            ...
            <div class="card">
                <div class="card-header justify-content-between">
                    <h5 class="card-title"> Table Group Dividers </h5>
            ...
            <div class="card">
                <div class="card-header justify-content-between">
                    <h5 class="card-title"> Table Head </h5>
