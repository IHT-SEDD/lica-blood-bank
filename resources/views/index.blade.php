...
'subTitle' =>
'A premium collection of elegant, accessible components and a powerful codebase. Built for modern frameworks. Developer
Friendly. Production Ready.',
'badgeIcon' => 'sparkles',
                ...
                <div class="align-items-center justify-content-between row text-center text-sm-start">
                    ...
                    <div class="col-sm-auto mt-3 mt-sm-0">
                        <ul class="pagination pagination-sm pagination-boxed mb-0 justify-content-center">
                            ...
                            <li class="page-item"><a class="page-link" href="#"><i class="ti ti-chevron-right"></i></a>
                            </li>
                        </ul>
                    </div> <!-- end col-->
                </div> <!-- end row-->
