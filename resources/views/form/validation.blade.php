...
'subTitle' =>
'Ensure data accuracy and user input quality with built-in and custom validation techniques using Bootstrap and
JavaScript.',
        ...
        <div class="card">
            <div class="card-header justify-content-between">
                ...
                <a class="icon-link icon-link-hover link-secondary link-underline-secondarlink-secondary link-underline-opacity-25 fw-semibold"
                    href="https://getbootstrap.com/docs/5.3/forms/validation/#custom-styles" target="_blank">View Docs
