...
<div class="outlook-box mt-4">
    <div aria-labelledby="outlookSidebaroffcanvasLabel"
        class="offcanvas-lg offcanvas-start outlook-left-menu rounded-start-4" id="outlookSidebaroffcanvas"
        tabindex="-1">
            ...
            <div class="w-100 text-center">
                <div class="card-body">
                    ...
                    <div class="d-flex gap-1 mt-2 align-items-center">
                        <button class="btn btn-sm btn-icon btn-default" data-bs-placement="top" data-bs-toggle="tooltip"
                            data-bs-trigger="hover" title="Attach files" type="button">
                            <i class="ti ti-paperclip fs-sm"></i>
                        </button>
                        <button class="btn btn-sm btn-icon btn-default" data-bs-placement="top" data-bs-toggle="tooltip"
                            data-bs-trigger="hover" title="Insert link" type="button">
                            <i class="ti ti-link fs-sm"></i>
                        </button>
                        <button class="btn btn-sm btn-icon btn-default" data-bs-placement="top" data-bs-toggle="tooltip"
                            data-bs-trigger="hover" title="Insert photo" type="button">
                            <i class="ti ti-photo-up fs-sm"></i>
                        </button>
                        <button class="btn btn-sm btn-icon btn-default" data-bs-placement="top" data-bs-toggle="tooltip"
                            data-bs-trigger="hover" title="Voice" type="button">
