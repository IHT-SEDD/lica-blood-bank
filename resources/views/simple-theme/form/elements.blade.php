                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row g-lg-4 g-2">
                            ...
                            <div class="col-lg-8">
                                <div class="app-search">
                                    <input class="form-control" id="SearchInput" placeholder="Search for something..."
                                        type="search" />
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="row g-lg-4 g-2">
                            ...
                            <div class="col-lg-8">
                                <input class="form-range" id="example-range" max="100" min="0" name="range"
                                    type="range" />
                            </div>
                        </div>
                    </div> <!-- end col -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="row g-lg-4 g-2">
                            ...
                            <div class="col-lg-8">
                                <div class="form-floating">
                                    <input class="form-control" id="floatingInputEmail" placeholder="name@example.com"
                                        type="email" />
                        ...
                        <div class="row g-lg-4 g-2">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="form-check">
                                    <input checked="" class="form-check-input" disabled="" id="checkCheckedDisabled"
                                        type="checkbox" value="" />
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="mb-2">
                                    <div class="form-check fs-lg form-check-inline">
                                        <input checked="" class="form-check-input" id="radioCash" name="paymentMethod"
                                            type="radio" value="cash" />
                                        <label class="form-check-label fs-base" for="radioCash">Cash</label>
                                    </div>
                                    <div class="form-check fs-lg form-check-inline">
                                        <input class="form-check-input" id="radioCard" name="paymentMethod" type="radio"
                                            value="card" />
                            ...
                            <div class="col-lg-8">
                                <div class="w-lg-50">
                                    <div class="form-check form-check-reverse mb-2">
                                        <input checked="" class="form-check-input" id="reverseCheck1" type="checkbox"
                                            value="" />
                            ...
                            <div class="col-lg-8">
                                <div class="d-flex flex-wrap gap-4">
                                    <div>
                                        ...
                                        <div class="form-check form-check-info mb-2">
                                            <input checked="" class="form-check-input" id="radioInfo" name="radioInfo"
                                                type="radio" />
                                    ...
                                    <div>
                                        ...
                                        <div class="form-check form-check-dark">
                                            <input checked="" class="form-check-input" id="radioDark" name="radioDark"
                                                type="radio" />
