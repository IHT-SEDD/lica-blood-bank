...
@section('content')
    @include('layouts.shared.page-title', [
        'title' => 'Form Wizard',
        'subTitle' =>
            'Guide users through multi-step forms with clear navigation and progress tracking for improved user experience.',
        'badgeIcon' => 'wand-sparkles',
        'badgeTitle' => 'Multi-Step Forms',
    ])
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="flex-grow-1">
                        <h5 class="card-title">Validation Support</h5>
                    </div>
                    <span class="badge badge-soft-success badge-label fs-xxs py-1">Exclusive</span>
                </div>
                <div class="card-body">
                                    ...
                                    <a class="nav-link active" data-bs-toggle="tab" href="#stepStudent">
                                        <span class="d-flex align-items-center">
                                            ...
                                            <span class="flex-grow-1 ms-2 text-truncate">
                                                <span class="mb-0 lh-base d-block fw-semibold text-body fs-base">Student
                                                    Info</span>
                                                <span class="mb-0 fw-normal">Your basic details</span>
                                            </span>
                                        </span>
                                    </a>
                                </li>
                                    ...
                                    <a class="nav-link" data-bs-toggle="tab" href="#stepCourse">
                                        <span class="d-flex align-items-center">
                                            ...
                                            <span class="flex-grow-1 ms-2 text-truncate">
                                                <span class="mb-0 lh-base d-block fw-semibold text-body fs-base">Course
                                                    Info</span>
                                                <span class="mb-0 fw-normal">Program preferences</span>
                                            </span>
                                        </span>
                                    </a>
                                </li>
                                    ...
                                    <a class="nav-link" data-bs-toggle="tab" href="#stepParent">
                                        <span class="d-flex align-items-center">
                                            ...
                                            <span class="flex-grow-1 ms-2 text-truncate">
                                                <span class="mb-0 lh-base d-block fw-semibold text-body fs-base">Parent
                                                    Info</span>
                                                <span class="mb-0 fw-normal">Guardian contact</span>
                                            </span>
                                        </span>
                                    </a>
                                </li>
                                    ...
                                    <a class="nav-link" data-bs-toggle="tab" href="#stepDocs">
                                        <span class="d-flex align-items-center">
                                            ...
                                            <span class="flex-grow-1 ms-2 text-truncate">
                                                <span
                                                    class="mb-0 lh-base d-block fw-semibold text-body fs-base">Documents</span>
                                                <span class="mb-0 fw-normal">Upload requirements</span>
                                            </span>
                                        </span>
                                    </a>
                                </li>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="flex-grow-1">
                        <h5 class="card-title">Progressbar Support</h5>
                    </div>
                    <span class="badge badge-soft-success badge-label fs-xxs py-1">Exclusive</span>
                </div>
                <div class="card-body">
                                                ...
                                                <span class="d-flex align-items-center">
                                                    ...
                                                    <span class="flex-grow-1 ms-2 text-truncate">
                                                        <span
                                                            ...
                                                            Info</span>
                                                        <span class="mb-0 fw-normal">Your personal
                                                            details</span>
                                                    </span>
                                                </span>
                                            </a>
                                                ...
                                                <span class="d-flex align-items-center">
                                                    ...
                                                    <span class="flex-grow-1 ms-2 text-truncate">
                                                        <span
                                                            ...
                                                            Info</span>
                                                        <span class="mb-0 fw-normal">Current location</span>
                                                    </span>
                                                </span>
                                            </a>
                                        </li>
                                                ...
                                                <span class="d-flex align-items-center">
                                                    ...
                                                    <span class="flex-grow-1 ms-2 text-truncate">
                                                        <span
                                                            ...
                                                            Info</span>
                                                        <span class="mb-0 fw-normal">Your academic
                                                            choices</span>
                                                    </span>
                                                </span>
                                            </a>
                                            ...
                                            <a class="nav-link" data-bs-toggle="tab" href="#verticalStepDocs">
                                                <span class="d-flex align-items-center">
                                                    ...
                                                    <span class="flex-grow-1 ms-2 text-truncate">
                                                        <span
                                                            class="mb-0 lh-base d-block fw-semibold text-body fs-base">Documents</span>
                                                        <span class="mb-0 fw-normal">Required uploads</span>
                                                    </span>
                                                </span>
                                            </a>
                                        </li>
