...
@section('content')
    @include('layouts.shared.page-title', [
        ...
        'subTitle' =>
            'Build interactive and lightweight maps using Leaflet.js — ideal for location markers, user tracking, and geo-data visualizations.',
        'badgeIcon' => 'map-pin',
        'badgeTitle' => 'OpenStreetMap Powered',
    ])
