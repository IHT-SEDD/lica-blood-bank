                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="carousel slide" data-bs-ride="carousel" id="carouselExampleControls">
                            <div class="carousel-inner" role="listbox">
                                ...
                                <div class="carousel-item">
                                    <!-- Second slide -->
                                    <img alt="Second slide" class="d-block img-fluid" src="/images/stock/small-5.jpg" />
                                </div>
                                <div class="carousel-item">
                                    <!-- Third slide -->
                                    <img alt="Third slide" class="d-block img-fluid" src="/images/stock/small-6.jpg" />
                                </div>
                            </div>
                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="carousel slide" data-bs-ride="carousel" id="carouselExampleIndicators">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active">
                                    <!-- First slide -->
                                    <img alt="First slide" class="d-block img-fluid" src="/images/stock/small-7.jpg" />
                                </div>
                                <div class="carousel-item">
                                    <!-- Second slide -->
                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="carousel slide carousel-fade" data-bs-ride="carousel" id="carouselExampleFade">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <!-- First slide -->
                                    <img alt="First slide" class="d-block img-fluid" src="/images/stock/small-6.jpg" />
                                </div>
                                <div class="carousel-item">
                                    <!-- Second slide -->
                                    <img alt="Second slide" class="d-block img-fluid" src="/images/stock/small-7.jpg" />
                                </div>
                                <div class="carousel-item">
                                    <!-- Third slide -->
                            ...
                            <div class="col-md-6">
                                <div aria-hidden="true" class="card border shadow-none mb-0">
                                    <svg aria-label="Placeholder" class="card-img-top"
                                        preserveaspectratio="xMidYMid slice" role="img" style="aspect-ratio: 16 / 10;"
                                        viewbox="0 0 16 10" width="100%" xmlns="http://www.w3.org/2000/svg">
