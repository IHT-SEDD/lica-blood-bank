...
@section('content')
    @include('layouts.shared.page-title', [
        ...
        'subTitle' =>
            'Add row selection features to your tables using DataTables Select extension — perfect for bulk actions and item management.',
        'badgeIcon' => 'check-square',
        'badgeTitle' => 'Row Selection',
    ])
        ...
        <div class="col-xxl-12">
            <div class="card">
                <div class="card-header justify-content-between">
                    <h5 class="card-title"> Single Item Select </h5>
            ...
            <div class="card">
                <div class="card-header justify-content-between">
                    <h5 class="card-title"> Multi Item Selection </h5>
                    <a class="icon-link icon-link-hover link-primary fw-semibold"
                        href="https://datatables.net/reference/option/select" target="_blank">View Docs <i
                            class="ti ti-arrow-right bi align-middle fs-lg"></i></a>
                </div>
            ...
            <div class="card">
                <div class="card-header justify-content-between">
                    <h5 class="card-title"> Cell Selection </h5>
                    <a class="icon-link icon-link-hover link-primary fw-semibold"
                        href="https://datatables.net/reference/option/select" target="_blank">View Docs <i
                            class="ti ti-arrow-right bi align-middle fs-lg"></i></a>
                </div>
