<!DOCTYPE html>
<html lang="en" data-sidenav-size="collapse">
 ...
 <div class="wrapper">
  ...
  <div class="content-page">
   <div class="container-fluid">
    ...
    <div id="fullscreen_loading_overlay"
     style="position: fixed; inset: 0; z-index: 9999; background: rgba(0, 0, 0, 0.45); backdrop-filter: blur(2px);"
