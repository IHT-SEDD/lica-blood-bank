...
@section('content')
    @include('layouts.shared.page-title', [
        ...
        'subTitle' =>
            'Browse and use beautifully crafted, open-source Tabler Icons to enhance your UI with clarity and style.',
        'badgeIcon' => 'pickaxe',
        'badgeTitle' => 'Icon Set',
    ])
            ...
            <div class="card">
                <div class="card-header d-block">
                    ...
                    <p class="mb-0 text-muted">Free and open source icons designed to make your website or app
                        attractive, visually consistent and simply beautiful.</p>
                </div> <!-- end card-header-->
                ...
                <div class="card-body border-top-0 rounded-top-0">
                    ...
                    <div class="text-center mt-3">
                        <a class="btn btn-danger" href="https://tabler.io/icons" target="_blank">View All
                            Icons</a>
                    </div>
                </div> <!-- end card-body-->
            </div> <!-- end card-->
