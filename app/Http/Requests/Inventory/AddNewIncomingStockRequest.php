...
class AddNewIncomingStockRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        if ($this->input('method_add') === 'manual') {
            ...
            $manualRules = [
                ...
                'blood_data.*.aftap_date' => ['required'],
                'blood_data.*.expiry_date' => ['required'],
                'blood_data.*.process_date' => ['nullable'],
    ...
    public function messages(): array
    {
        return [
            ...
            'blood_data.*.blood_pack_id.required' => 'Kantong darah wajib dipilih.',
