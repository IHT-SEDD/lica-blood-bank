<?php return array (
  ...
  array (
    ...
    'faker_locale' => 'en_US',
    'cipher' => 'AES-256-CBC',
    'key' => 'base64:RP02ql8uqvkX0k+2R8mr9vrX/wlf71nHWc+EBn2+Nzo=',
    'previous_keys' => 
    array (
    ),
    'maintenance' => 
...
',
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'single',
        'path' => 'C:\\laragon\\www\\lica-blood-bank\\storage\\logs/blood-transfusion/new-blood-transfusion-data.log',
        'level' => 'debug',
      ),
      'updatebloodtransfusion' => 
      array (
        'driver' => 'single',
        'path' => 'C:\\laragon\\www\\lica-blood-bank\\storage\\logs/blood-transfusion/update-blood-transfusion-data.log',
        'level' => 'debug',
      ),
      'donebloodtransfusion' => 
      array (
        'driver' => 'single',
        'path' => 'C:\\laragon\\www\\lica-blood-bank\\storage\\logs/blood-transfusion/done-blood-transfusion-data.log',
        'level' => 'debug',
      ),
      'completebloodtransfusion' => 
      array (
        'driver' => 'single',
        'path' => 'C:\\laragon\\www\\lica-blood-bank\\storage\\logs/blood-transfusion/complete-blood-transfusion-data.log',
        'level' => 'debug',
      ),
      'incompatibleresult' => 
      array (
        'driver' => 'single',
        'path' => 'C:\\laragon\\www\\lica-blood-bank\\storage\\logs/blood-transfusion/incompatible-blood-transfusion-data.log',
        'level' => 'debug',
      ),
      'bloodstockactivity' => 
      array (
        'driver' => 'single',
        'path' => 'C:\\laragon\\www\\lica-blood-bank\\storage\\logs/blood-transfusion/blood-stock-blood-transfusion-data.log',
        'level' => 'debug',
      ),
    ),
  ),
  ...
  array (
    ...
    array (
      'version' => '1.0.0',
      'description' => 'API Library Documentation of LICA Blood Bank, An Advance & Comprehensive Blood Bank Management System for Your Hospital',
    ),
    'ui' => 
    array (
      'title' => 'API Documentation of LICA Blood Bank',
      'theme' => 'light',
      'hide_try_it' => false,
      'hide_schemas' => false,
      'logo' => '',
